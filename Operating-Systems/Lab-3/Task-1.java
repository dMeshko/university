...
public class TancSoStudentite {
	...
	public Semaphore danceFloor;
    public Semaphore manChangingRoom;
    public Semaphore womanChangingRoom;
    public Semaphore manHere;
    public Semaphore womanHere;

    public void init() {
        //TODO: da se implementira
        danceFloor = new Semaphore(3);
        manChangingRoom = new Semaphore(10);
        womanChangingRoom = new Semaphore(10);
        manHere = new Semaphore(0);
        womanHere = new Semaphore(0);
    }
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
        	manChangingRoom.acquire(); //man entered the changing room
            show.presobleci();
            manChangingRoom.release();
    ...
    class Zensko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
        	womanChangingRoom.acquire(); //woman entered
            show.presobleci();
            womanChangingRoom.release();
            womanHere.release();
            manHere.acquire();
        }
